...
class TestMultipleDevices(MultipleDeviceTestCase):
    ...
    def test_group_chat_send_receive_messages_and_remove_user(self):
        ...
        device_2_chat.send_message_button.click()
        device_2_chat.find_text_part("removed you from group chat")
        if device_2_chat.element_by_text(message_3, 'text').is_element_present(20):
    ...
    def test_send_funds_via_request(self, test, recipient, sender):
        ...
        if test == 'group_chat':
            ...
            device_2_home.element_by_text_part(recipient['username'][:25], 'button').click()
        device_1_chat = device_1_home.get_chat_view()
        device_2_chat = device_2_home.get_chat_view()
        ...
        if test == 'group_chat':
            device_1_chat.find_full_text('from  ' + recipient['username'], 20)
            device_2_chat.find_full_text('from  ' + recipient['username'], 20)
